      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="page-header" style="margin-top:5px;">
            <h3>Form: Edit animal</h3>
          </div>
          <form:form role="form" CssClass="form-horizontal" method="post" action = "updateAnimal.do" commandName = "editAnimal">
            <div class="form-group">
              <form:label for="id" path="id" cssClass="col-sm-2 control-label">Id</form:label>
              <div class="col-sm-10">
                <div class="input-group col-sm-6">
                  <form:input id="id" path="id" cssClass="form-control" readonly="true" />
                  </div>
                  <div class="has-warning">
                    <div class="help-block">Id is unchangable</div>
                  </div>
            </div>
